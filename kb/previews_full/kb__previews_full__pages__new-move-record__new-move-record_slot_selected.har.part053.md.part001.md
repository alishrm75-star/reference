### kb/previews_full/pages__new-move-record__new-move-record_slot_selected.har.part053.md (part 001)

```md
### pages/new-move-record/new-move-record_slot_selected.har (part 053)
