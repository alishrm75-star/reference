### kb/previews_full/kb__previews_full__kb__previews_full__kb__previews_full__pages__new-move-record__new-move-record_future-date.har.part210.md.part001.md.part001.md.part001.md (part 001)

```md
### kb/previews_full/kb__previews_full__kb__previews_full__pages__new-move-record__new-move-record_future-date.har.part210.md.part001.md.part001.md (part 001)

```md
### kb/previews_full/kb__previews_full__pages__new-move-record__new-move-record_future-date.har.part210.md.part001.md (part 001)

```md
### kb/previews_full/pages__new-move-record__new-move-record_future-date.har.part210.md (part 001)

```md
### pages/new-move-record/new-move-record_future-date.har (part 210)
...
```har
        ...
        "response": {
          ...
          "headers": [
            ...
            {
              "name": "traceparent",
              "value": "00-021253feecb620a7ee3cd3d8204ccf20-f1e24c589adefd94-01"
            },
            {
              "name": "vary",
        ...
        "startedDateTime": "2025-10-07T11:24:39.004Z",
        "time": 10.589999961666763,
        "timings": {
          "blocked": 3.5180000339224935,
          "dns": -1,
          "ssl": -1,
          "connect": -1,
          "send": 0.534,
          "wait": 5.856999980963766,
          "receive": 0.6809999467805028,
          "_blocked_queueing": 2.0990000339224935,
          "_blocked_proxy": 0.903,
          "_workerStart": -1,
          "_workerReady": -1,
          "_workerFetchStart": -1,
