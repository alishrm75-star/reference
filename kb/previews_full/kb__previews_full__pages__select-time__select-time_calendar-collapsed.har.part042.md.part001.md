### kb/previews_full/pages__select-time__select-time_calendar-collapsed.har.part042.md (part 001)

```md
### pages/select-time/select-time_calendar-collapsed.har (part 042)
