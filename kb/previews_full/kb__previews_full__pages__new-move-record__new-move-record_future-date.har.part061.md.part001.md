### kb/previews_full/pages__new-move-record__new-move-record_future-date.har.part061.md (part 001)

```md
### pages/new-move-record/new-move-record_future-date.har (part 061)
