### kb/previews_full/pages__create-record__create-record_ready.har.part022.md (part 001)

```md
### pages/create-record/create-record_ready.har (part 022)
